...
const LivePreview: React.FC = () => {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="bg-base-300 rounded-2xl border border-base-200 flex flex-col">
          <div className="flex items-center justify-between p-2 border-b border-base-200">
          ...
          <div className="p-1 m-7">
            <div className="space-y-3">
              ...
              <div className="text-center">
                <p className="text-sm opacity-70">Selected color: <span className="font-mono">{color}</span></p>
              </div>
            </div>
          </div>
        </div>
...
const CodeCard: React.FC<CodeCardProps> = ({ title, code }) => (
  <LazyMotion features={domAnimation}>
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
    >
      <div className="bg-base-300 p-6 rounded-2xl border border-base-200">
