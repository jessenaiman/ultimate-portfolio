...
function App() {
  ...
  console.log('PUBLIC_APPWRITE_PUBLIC_ENDPOINT:', import.meta.env.PUBLIC_APPWRITE_PUBLIC_ENDPOINT);
  console.log('PUBLIC_APPWRITE_PROJECT_ID:', import.meta.env.PUBLIC_APPWRITE_PROJECT_ID);
  console.log('PUBLIC_APPWRITE_PROJECT_NAME:', import.meta.env.PUBLIC_APPWRITE_PROJECT_NAME);
              ...
              <div className="grid grid-cols-2 gap-4 p-4">
                <div className="flex flex-col">
                  ...
                  <span className="truncate">
                    {import.meta.env.PUBLIC_APPWRITE_PUBLIC_ENDPOINT}
                  </span>
                </div>
                <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="truncate">
                    {import.meta.env.PUBLIC_APPWRITE_PROJECT_NAME || "Appwrite Project"}
                  </span>
                </div>
              </div>
            </div>
