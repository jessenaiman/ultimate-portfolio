---
title: Camps for Imaginative Kids and Adults
description: >-
  Get involved in the first annual fantasy camp. This is a place where kids can
  learn to play D&D, and adults can learn to play D&D. We will have a variety of
  activities, and a focus on creating a world of your own.
...
style:
  ...
  hero_image_opacity: ''
  container: md
pubDate: '2023-09-01T15:52:07.000Z'
...
It will take a lot of reserve gold to run a camp to hire everyone needed to make this happen. Those amazing parents (that’s you) with skills that can help in anyway are encouraged to offer those skills.

Core roles we will need will be:
...
There will be a camp store, and some things are only exchangeable for gold coins (crafts).
...
Watch as your kids offer to clear your table just so they can earn a plastic coin.
...
Everyone under the age of 18 MUST be in their designated spots.
...
When the event reaches it’s conclusion, we will send ask for feedback to improve and focus on what worked best, because this is only the first of many adventures for fantasy camp.
...
It is my belief that the songs and stories shared of those generations are an important milestone that insisted the human spirit move always forward towards greater harmony.
...
2. Intermediate:
   a. You are expected to know your character sheet, and to have all the information ready to share if asked.  
   b. All dice should be rolled at the same time
   c. During combat your turn must be shorter than 2 minutes--that’s 10 minutes a round for a 5 person game if they maxed it out, so we want to think about making the rounds short and snappy so we can get another turn.
3. Advanced:
   a. You are willing to work with the Game Director to include secrets, proficiencies, and a history for your character.
   b. You come to the game bringing your full enthusiasm and attention.
   c. This requires going above just bringing your character, and to play at these tables you’ll need to win the approval of the Game Director and party members.
...
Here’s what they will learn that you probably only want to retroactively discuss:

1. Colour Theory
2. Chemistry:
   a. Silicone molds or resin will be mixed and discussed to create take home dice
   b. Mixing colours properly requires a basic understanding of chemistry
3.

If you have a child participating you are allowed to enroll, and to learn how to do these activities as well.

Your kids are going to get to be mad scientist with lab coats, learning about chemistry while also making amazing looking dice, and creating their own specific paint brand in a bottle to take home.

Learning is automatic and subconscious when we’re having fun.
...
1. Prime your models, and learn about painting the base layer of a model.
   a. We begin by priming the model you have brought, but this now needs 24-48 hours before we can move to the next step.
   b. Everyone will select a floor, or wall piece from a primed selection provided.
   c. Let’s get painting. For this part I will discuss a lot of stuff as we paint, but it’s more important to get the brush moving and play first.
2. Base Layers, Wet Palettes
   a. You will be given the materials to create a low-cost wet pallet which you will assemble.
   b. We will paint our models together, learning and experimenting with laying down the base layer.
   c. We can then revisit the scenery piece that has a base layer already dried and apply a wash or try dry brushing
3. Washes and Dry Brushing
   a. We introduce washes to demonstrate how you can blend the base layers. At this stage you can decide what technique to try on your model. The goal is to add a layer and set it aside again.
   b. Revisit the scenery to add details or start another piece. Practice so that next week you are confident to get into the fine details of your model.
4. Detailing and Bases
   a. Your model is going to be looking pretty good at this stage. I will help suggest ways to level up the work you have already done and discuss the final stages of varnishing/protecting your model.
   b. Your model needs to be attached to a base. I will also provide some primed 3d model bases that you are welcome to take as an alternative to the ones provided with your model.
   c. Glue and attach your model to the base and set it aside for next week.
5. Varnishing and Advanced Paint Techniques
   a. We will take our models and either brush or spray varnish them. This will protect your model so they can be handled and retain their colour. It is still advisable to keep your painted projects away from direct sunlight as much as possible.
   b. I will introduce Mediums and Professional Acrylic paint creates more vibrant colours and effects.
   i. You will have several options available to experiment with professional grade acrylics available, scenery, primed art paper, or canvas.
   ii. I will demonstrate how to mix mediums to create contrast and speedpaint effects.
...
o Level 1 Games (Ages 8-13). These games do not require a player to understand anything beyond basic listening skills. Your friendly Game Director at each table will have all the resources and knowledge that you need to enjoy a D&D game
o Level 2 Games (Ages 13-18). These will start at a higher level, and each player will be required to be more heroic and involved as a team player.
o Adult Games – You are encouraged to join a group, and there will be signup forms.

12:00 Lunch

1:10-2:20 – Activity Time
o Dice Making (13+)
o Painting (Models, Portraits, Rocks)

2:30-3:40 – Exploration Time
o The Multiverse of Table Top Games Part 1(13+) – Each day explore a one-shot in an entirely new system
o Improv Game
o Fantasy Camp Fairies - Camp needs houses for fairies, sign posts for Elves. Decorate the camp, and learn how to enhance the natural environment around us. Everything designed in this workshop can be taken home, or is biodegradable, non-toxic, and preserves the habitat in it’s original form.

3:50-4:00 – Snack Time

4:10-5:20 - Downtime
o The Multiverse of Table Top Games Part 2(13+) – Finish the daily one-shot adventure
o Lessons in Mastering the Game – Workshop techniques, and practice together how to be a better Game Master.
o **\_\_\_** Need some 8-13 activities here!
5:30-6:30 - Dinner

6:40-8:30 – Game Time #2 – Everyone returns to play the game they are enrolled in from the morning

8:40-9:30 – Bedtime Stories – Every night we will gather and listen together to tales.
